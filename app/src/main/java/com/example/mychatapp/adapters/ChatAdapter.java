...
import com.example.mychatapp.databinding.ItemContainerRecievedMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == VIEW_TYPE_SENT){
            ((SentMessageViewHolder) holder).setData(chatMessages.get(position), receiverProfileImage);
        }else{
    ...
    static class ReceiveMessageViewHolder extends RecyclerView.ViewHolder{
        ...
        ReceiveMessageViewHolder(@NonNull ItemContainerRecievedMessageBinding itemContainerSentMessageBinding){
            super(itemContainerSentMessageBinding.getRoot());
            binding = itemContainerSentMessageBinding;
        }
        void setData(ChatMessage chatMessage, Bitmap receiverProfileImage){
